    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            ...
            case R.id.menuEditThisWatch:
                Intent editWatchIntent = new Intent(DisplayResultActivityOld.this, EditWatchActivity.class);
                ...
                .setPositiveButton(this.getString(android.R.string.yes),
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                try {
                                    new Importer().doImport(DisplayResultActivityOld.this);
                                    Intent intent = new Intent(DisplayResultActivityOld.this, FinActivity.class).
