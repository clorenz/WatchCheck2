 ...
 * DAO for table WATCH.
*/
public class WatchDao extends AbstractDao<Watch, Long> {

    public static final String TABLENAME = "WATCH";

    /**
     * Properties of entity Watch.<br/>
    ...
    */
    ...
    public WatchDao(DaoConfig config) {
        super(config);
    }
    
    public WatchDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'WATCH' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'WATCH'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Watch entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(Watch entity) {
    ...
    /** @inheritdoc */
    @Override
    public Watch readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Watch entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Watch entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Watch entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
